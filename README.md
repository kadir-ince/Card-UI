...
<p>
  <img src="https://github.com/kadir-ince/Card-UI/blob/master/whats-like.gif" width="350" alt="how to working gif">
</p>
...
<br>
1️⃣ ``` git clone https://github.com/kadir-ince/Card-UI.git ```  <br>
2️⃣ ``` cd Card-UI ``` <br>
3️⃣ ``` xed . ``` <br>
